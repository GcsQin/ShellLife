...
public class WebJobDetialsActivity extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String href=bundle.getString("jobUrl");
        setContentView(R.layout.activity_web_job);
        ...
        webView=(WebView)findViewById(R.id.web_job);
...
//        webView.getSettings()
    ...
    public void backHome(View view){
        startActivity(new Intent(WebJobDetialsActivity.this,IJobActivity.class));
