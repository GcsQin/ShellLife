...
public class WebLibraryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("http://lib.ustb.edu.cn/");
    }
    public void refresh(View view){
        webView.reload();
    }
    public void backHome(View view){
        startActivity(new Intent(WebLibraryActivity.this, IOfficialWebListActivity.class));
