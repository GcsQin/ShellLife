...
public class WebSchoolNewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView=(WebView)findViewById(R.id.web_teach);
...
//        webView.getSettings()
        ...
        webView.loadUrl("http://news.ustb.edu.cn/");
    }
    public void refresh(View view){
        webView.reload();
    }
    public void backHome(View view){
        startActivity(new Intent(WebSchoolNewActivity.this, IOfficialWebListActivity.class));
