...
public class WebCampusOAActivity extends AppCompatActivity {
    private WebView webView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_learn_web_google);
        ...
        webView=(WebView)findViewById(R.id.web_schooloa);
        ...
        webView.loadUrl("http://oa.ustb.edu.cn/edoas2/website6/index.jsp");
    }
    public void refresh(View view){
        webView.reload();
    }
    public void backHome(View view){
        startActivity(new Intent(WebCampusOAActivity.this, IOfficialWebListActivity.class));
