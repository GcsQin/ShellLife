...
public class WebQualityDevelopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_web_quality_develop);
        ...
        webView=(WebView)findViewById(R.id.web_qullity_develop);
...
//        webView.getSettings()
        ...
        webView.loadUrl("http://zhiyuan.ustb.edu.cn/");
    ...
    public void backHome(View view){
        startActivity(new Intent(WebQualityDevelopActivity.this, IOfficialWebListActivity.class));
